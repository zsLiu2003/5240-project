...
| Main + Aug (0.5) | 0.1340 +/- 0.0165 | 0.1052 +/- 0.0119 | 0.5163 +/- 0.2126 | 3 | main_method_aug0.5_seed*/results.json |
...
- Under the standard 3-seed split protocol, Main + Aug (0.5) changes RMSE by +16.66% (0.1608 -> 0.1340).
